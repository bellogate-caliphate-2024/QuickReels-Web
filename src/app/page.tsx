...
export default function Home() {
  const [mockThumbnails] = useState<Thumbnail[]>(
    Array.from({ length: 6 }, (_, i) => ({
      ...
      title: `Reel ${i + 1}`,
      thumbnailUrl:
        "/What-Does-a-Social-Media-Manager-Do-Reach-Marketing-Pro-768x768.png",
    })),
  );
  ...
  return (
    <>
      <h1 className="text-3xl font-bold mb-6 text-gray-800">QuickReels</h1>
        ...
        {mockThumbnails.map(({ id, title, thumbnailUrl }) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <p className="text-sm text-gray-600 mt-1">00:30</p>{" "}
              {/* Add duration */}
            </div>
          </div>
        ))}
